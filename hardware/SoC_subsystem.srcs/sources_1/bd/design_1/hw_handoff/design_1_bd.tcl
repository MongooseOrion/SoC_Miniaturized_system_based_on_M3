...
proc create_root_design { parentCell } {
  ...
  # Create instance: swdio_tri_buffer_1, and set properties
  set block_name swdio_tri_buffer
  set block_cell_name swdio_tri_buffer_1
  if { [catch {set swdio_tri_buffer_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $swdio_tri_buffer_1 eq "" } {
  ...
  connect_bd_net -net CORTEXM3_AXI_0_SWDO [get_bd_pins CORTEXM3_AXI_0/SWDO] [get_bd_pins swdio_tri_buffer_1/swd_o]
  connect_bd_net -net CORTEXM3_AXI_0_SWDOEN [get_bd_pins CORTEXM3_AXI_0/SWDOEN] [get_bd_pins swdio_tri_buffer_1/swd_oe]
  ...
  connect_bd_net -net Net [get_bd_ports swd_io_0] [get_bd_pins swdio_tri_buffer_1/swd_io]
  ...
  connect_bd_net -net clk_wiz_0_sys_clk [get_bd_pins CORTEXM3_AXI_0/HCLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/sys_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  connect_bd_net -net swdio_tri_buffer_1_swd_i [get_bd_pins CORTEXM3_AXI_0/SWDITMS] [get_bd_pins swdio_tri_buffer_1/swd_i]

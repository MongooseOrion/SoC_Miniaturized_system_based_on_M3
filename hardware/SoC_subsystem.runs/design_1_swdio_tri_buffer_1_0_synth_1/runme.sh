...
HD_PWD='C:/Users/smn90/SoC_subsystem/SoC_subsystem.runs/design_1_swdio_tri_buffer_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_swdio_tri_buffer_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_swdio_tri_buffer_1_0.tcl
